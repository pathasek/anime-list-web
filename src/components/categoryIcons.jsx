// Sdílené SVG ikony kategorií hodnocení.
// Používá je CategoryRatingsPanel (karty + radar) a RatingGuideModals (průvodce hodnocením).
...
export const iconFor = (cat) => CATEGORY_ICONS[cat] || DEFAULT_ICON
